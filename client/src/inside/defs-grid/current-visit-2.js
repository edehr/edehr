export default function () {
  return {
    genitourinary: {
      ...
      recHeader: true,
      generated: '2020-08-21T10:32:52-07:00',
      pageElements: {
        table: {
          elementKey: 'table',
          tableKey: 'table',
    ...
    integumentaryAssessment: {
      ...
      pageElements: {
        ...
        tableIncisionStatus: {
          elementKey: 'tableIncisionStatus',
          tableKey: 'tableIncisionStatus',
          isTable: true,
          label: 'Incision status assessment',
          addButtonText: 'Add an incision status assessment',
          ehr_list: [
            {
              label: 'Identification',
              ehr_list_index: '1',
        ...
        tableIntegumentary: {
          elementKey: 'tableIntegumentary',
          tableKey: 'tableIntegumentary',
          isTable: true,
