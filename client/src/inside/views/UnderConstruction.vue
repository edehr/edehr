...
<template lang="pug">
  div(class="ehr-page")
    ...
    div(style="display:none")
      p This Med Lab Imaging page is generated.
      p Label: Med Lab Medical Imaging
      p Data Key: medLabImaging
      p Component name: UnderConstruction
      p Redirect: 
      p Route name: med-lab-imaging
      p Full path: /ehr/med-lab/med-lab-imaging
</template>
