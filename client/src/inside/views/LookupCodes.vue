...
<template lang="pug">
  div(class="ehr-page")
    ...
    div(style="display:none")
      p This Lookup Codes page is generated.
      p Label: Code lookup
      p Data Key: lookupCodes
      p Component name: LookupCodes
      p Redirect: 
      p Route name: lookup-codes
      p Full path: /ehr/external/lookup-codes
</template>
