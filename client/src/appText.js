...
export const ehrOnlyDemoText = {
  ...
  intro: 'The EdEHR is comprised of two parts. First is the simulated electronic health record (EHR) system and a learning management area. On this page you can explore the EHR. ' +
    'Contact mailto:info@edehr.org to learn more about the whole application ',
  explanation:
