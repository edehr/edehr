<template lang='pug'>
  div
    ...
    app-dialog(:isModal="true", ref="theDialog", :useSave="false", @cancel="proceed", cancelButtonLabel="OK")
      h2(slot="header") About EdEHR and support for French
      div(slot="body")
        p The support for French is a work-in-progress. The translations you will see have been provided by machines not people. Please do not depend on these translations until they have been reviewed.   All the text the student sees will be translated. Other text as seen by faculty will be translated later.
        p.
...
import { t18EhrText, t18GetLanguage, t18SetEnglish, t18SetFrench } from '@/helpers/ehr-t18'
