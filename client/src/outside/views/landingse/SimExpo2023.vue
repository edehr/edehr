<template lang="pug">
  div(class='simexpo2023')
    div(class='lcInner')
      div(class="welcome")

        div(class="wPanel")
          p.
            The EdEHR project is going to <a href="https://event.fourwaves.com/2023simexpo/pages">SimExpo2023</a>!

        img(src='/assets/landing/SimExpo2023.png', alt='SimExpo 2023 logo')

        h2(class="wTitle") Frequently ask questions about the EdEHR;

        div(class="wPanel")
          p.
            Welcome to the EdEHR, an <strong>Educational</strong> Electronic Health Record (EHR) system that
            contains a Lab Information System (LIS).  This application is ready to help future health care professionals practice theor digital competencies.
          p.
            The contents on this page are 6 months out of date and will be update very soon and well before
            <a href="https://event.fourwaves.com/2023simexpo/pages">SimExpo2023</a>. Nonetheless the following
            will answer many of your questions.

          p.
            Reach out to <a href="mailto:info@edehr.org">info@edehr.org</a> for more information.
        ...
        lab-con-section(title="How can my school use this educational charting tool?")
          saas-panel
