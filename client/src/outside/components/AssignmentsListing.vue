<template lang="pug">
  div(:class="$options.name")
    ...
    div(v-if="isRespondingToError")
      ...
      p Adjust your learning management system administrator to use a learning object from the list below
...
const DEFAULT_ASSIGNMENT_DESCRIPTION = 'This learning object was automatically generated by an LTI request. Please update this description by editing in the EdEHR.'
...
export default {
  ...
  methods: {
    ...
    isItemMisconfigured (item) {
      const needWarn = item.description === DEFAULT_ASSIGNMENT_DESCRIPTION ||
        DEFAULT_SEED_NAME === item.seedDataObj.name ||
        DEFAULT_SEED_DESCRIPTION === item.seedDataObj.description
      this.validationWarning = needWarn ? 'Shaded rows need further configuration. ': ''
      return needWarn
    },
    canBeDeleted (item) {
