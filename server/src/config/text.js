...
export const Text = {
  ...
  ASSIGNMENT_REQUIRE_EXTERNAL_ID: (key, id) => `To create an learning object we need the externalId for tool consumer ${key} - ${id}`,
  ASSIGNMENT_REQUIRE_RESOURCE: (key, id) => `To create an learning object we need a resource_link_title for tool consumer ${key} - ${id}`,
